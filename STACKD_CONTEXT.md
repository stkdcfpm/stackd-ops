...
| Field | Value |
|-------|-------|
| Last updated | 27 August 2026 (verified against `main` @ `b3e4908`, code-level facts confirmed by running `node tests/run.js`) |
| Current version | v2.9.63 |
