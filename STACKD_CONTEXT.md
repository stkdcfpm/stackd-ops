...
| Field | Value |
|-------|-------|
| Last updated | 31 August 2026 (verified on branch `claude/sync-002-batch-requests`, pending merge — commit hash to be corrected against `main` in the post-merge tracker tidy-up, per established convention; code-level facts confirmed by running `node tests/run.js`) |
...
## Version history (v2.9.32 → v2.9.67 — everything shipped since this file was last updated)
