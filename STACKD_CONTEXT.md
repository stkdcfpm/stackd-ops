...
| Field | Value |
|-------|-------|
| Last updated | 31 August 2026 (verified against `main` @ `4a7792f`, code-level facts confirmed by running `node tests/run.js`) |
| Current version | v2.9.67 |
| Test count | 630 / 630 passing (confirmed by re-running the suite, not just read from source) |
| Build branch | main |
