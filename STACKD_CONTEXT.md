...
| Field | Value |
|-------|-------|
| Last updated | 31 August 2026 (verified against `main` @ `8a77ffe`, code-level facts confirmed by running `node tests/run.js`) |
