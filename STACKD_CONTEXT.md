...
| Field | Value |
|-------|-------|
| Last updated | 31 August 2026 (this update covers REQ-AI-GAP-011, built and tested on branch `claude/ai-gap-011-rfq-email-parse`, PR pending at time of writing — code-level facts confirmed by running `node tests/run.js` on that branch; REQ-ORD-006/v2.9.69 is confirmed merged to `main` via PR #119) |
| Current version | v2.9.70 |
| Test count | 671 / 671 passing (confirmed by re-running the suite, not just read from source) |
| Build branch | main |
...
## Version history (v2.9.32 → v2.9.70 — everything shipped since this file was last updated)
