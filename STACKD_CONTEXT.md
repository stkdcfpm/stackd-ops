...
| Field | Value |
|-------|-------|
| Last updated | 30 August 2026 (branch `claude/integ002-2b-invoice-po-enum`, PR pending merge — code-level facts confirmed by running `node tests/run.js`) |
