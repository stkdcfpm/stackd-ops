...
|---|---|---|---|
| `saveInv()` | `7002-7190` | create/update | ✓ own create-or-update branch |
...
| `saveCN()` | `9999-10052` | create/update, also mutates a *different* invoice's `calc_balanceDue` in place (`10036-10048`) | ✓ own create-or-update branch, plus `persistInvChange()` for the side-mutated invoice |
