...
**Status:** v1 — drafted, not yet requirements-gated. §0.1's proceed-now-vs.-wait-for-2d question is resolved: user confirmed proceed now. This is the final sub-phase of the cross-platform backend migration (`docs/architecture-data-model-v1.md` §8); once it ships, every entity named in that document's migration roadmap is Cloud-Data-eligible.
