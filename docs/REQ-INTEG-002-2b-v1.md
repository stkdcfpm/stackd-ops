...
**Status:** v1 — requirements-gate independent review: **PASS** (1 advisory-only nit, a slightly overreaching sentence in §1.1 about `po.invId` assignment sites, corrected in place — no blocking findings).
