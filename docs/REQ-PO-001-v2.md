...
**Status:** Draft v2 — requirements-gate FAILED v1 on four findings (no FM-1 assessment, unaddressed residual risk for historical mis-attributed POs, AC-005/AC-004 not independently testable as worded); this revision addresses all four (see §8 Changelog)
**Version:** 2
**Date:** 2026-07-11
...
**Supersedes:** REQ-PO-001-v1 (requirements-gate FAIL — see §8 Changelog)
...
**v2 (this version):** Resubmitted after requirements-gate FAIL on v1. Four findings addressed:
