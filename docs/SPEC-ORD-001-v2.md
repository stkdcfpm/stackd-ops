...
**Status:** Draft v2 — spec-gate FAILED v1 on four findings (unimplementable multi-invoice-per-PO aggregation claim, inaccurate restore-dialog claim, missing dangling-`contactId` render guard, missing `activeQuoteId` write-back mechanism); this revision addresses all four (see §12 Changelog)
**Date:** 2026-07-11
...
**Supersedes:** SPEC-ORD-001-v1 (spec-gate FAIL — see §12 Changelog)
