...
### PO-GAP-003 — Invoice ↔ auto-generated PO drift: edits after first save never re-sync, no warning *(Open)*
...
**Decision:** Logged as found, not yet fixed — fix planned as part of Phase 1 of a broader Order Request → Quote → Invoice referential integrity build (not yet briefed/gated as of this entry).
...
### ORD-GAP-003 — RFQ commit ↔ Quote drift: no back-reference, no staleness warning *(Open)*
