...
### SYNC-GAP-001 — pullAll() merges Sheets rows keyed by display header, never translated back to internal field names — corrupts every pulled record and silently breaks delete
