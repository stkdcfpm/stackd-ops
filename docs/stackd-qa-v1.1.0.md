...
### v2.4.5 — 2026-04-21
**Fix:** CSV template download — flattened template arrays from multiline to single-line format. Multiline array format caused header and example values to merge on download. Templates updated with real FPM data: INV10029 example row, Island Fresh Imports, correct amounts.
